...
var s_account = s_account || "furniturecom,furnglobalprod";
...
//s.linkInternalFilters="javascript:,shop.flooringamerica.com"
s.linkLeaveQueryString=false
s.linkTrackVars="None"
//s.linkTrackEvents="None"
s.dc=122

/** Start ClickTale Integration**/
s.maxDelay=750;
s.loadModule("Integrate");
s.Integrate.onLoad=function(s,m){

    /* BEGIN: ClickTale integration code v1.2 */
    ...
    if(typeof ClickTaleRegisterFormSubmit!='function') s.Integrate.ClickTale.delay();
    ...
    /* END: ClickTale integration code */
    
}


/**		IMPORTANT: 
 * 			The Integrate Module must also be included for the above code to function correctly. This module
 * 			is pasted below for convenience.
 * 
 *			Note: You may already be including this module in your code, so please double check to prevent duplication.  
 */
 
 /****************************** MODULES *****************************/
/* Module: Integrate (for legacy "H" code only) */
