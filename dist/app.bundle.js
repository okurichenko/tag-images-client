...
_jquery2.default.fn.imageTag = function ($img, tagsData) {
  tagsData.forEach(function (tagData) {
    var $tag = (0, _jquery2.default)('<a class="image-tag"><div class="image-label">' + tagData.label + '</div></a>');
    ...
    $tag.on('window-resized', function () {
      if ($img.is(":visible")) {
        recalculate($tag, $img, tagData);
      } else {
    ...
    (0, _jquery2.default)('#image-tags').append($tag);
  });
};
...
(0, _jquery2.default)('document').ready(function () {
  ...
  (0, _jquery2.default)('body').prepend('<div id="image-tags"></div>');
  console.info('I see tagsData as', tagsData);

  var _loop = function _loop(i) {
    var $i = (0, _jquery2.default)('img[src$="' + i + '"]');
    if ($i.length) {
  ...
  (0, _jquery2.default)(window).on('resize', function () {
    ...
    wrTimeout = setTimeout(function () {
      (0, _jquery2.default)('.image-tag').trigger('window-resized');
    }, 300);
  });
});
